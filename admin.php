...
<table width=600px cellpadding=2 cellspacing=1>
<tr><td class=row1 align=right>Иконка: <b>img/1.png</b> &nbsp; <img src='img/1.png'></td><td class=row2><input type=text value=\"$topic1\" style='width:399px' name=topic1 size=10></td></tr>
<tr><td class=row1 align=right>Иконка: <b>img/2.png</b> &nbsp; <img src='img/2.png'></td><td class=row2><input type=text value=\"$topic2\" style='width:399px' name=topic2 size=10></td></tr>
<tr><td class=row1 align=right>Иконка: <b>img/3.png</b> &nbsp; <img src='img/3.png'></td><td class=row2><input type=text value=\"$topic3\" style='width:399px' name=topic3 size=10></td></tr>
<tr><td class=row1 align=right>Иконка: <b>img/4.png</b> &nbsp; <img src='img/4.png'></td><td class=row2><input type=text value=\"$topic4\" style='width:399px' name=topic4 size=10></td></tr>
<tr><td class=row1 align=right>Иконка: <b>img/5.png</b> &nbsp; <img src='img/5.png'></td><td class=row2><input type=text value=\"$topic5\" style='width:399px' name=topic5 size=10></td></tr>
<tr><td class=row1 align=right>Иконка: <b>img/6.png</b> &nbsp; <img src='img/6.png'></td><td class=row2><input type=text value=\"$topic6\" style='width:399px' name=topic6 size=10></td></tr>
<tr><td class=row1 align=right>Иконка: <b>img/7.png</b> &nbsp; <img src='img/7.png'></td><td class=row2><input type=text value=\"$topic7\" style='width:399px' name=topic7 size=10></td></tr>
<tr><td class=row1 align=right>Иконка: <b>img/8.png</b> &nbsp; <img src='img/8.png'></td><td class=row2><input type=text value=\"$topic8\" style='width:399px' name=topic8 size=10></td></tr>
<tr><td class=row1 align=right>Иконка: <b>img/9.png</b> &nbsp; <img src='img/9.png'></td><td class=row2><input type=text value=\"$topic9\" style='width:399px' name=topic9 size=10></td></tr>
<tr><td class=row1 align=right>Иконка: <b>img/10.png</b> &nbsp; <img src='img/10.png'></td><td class=row2><input type=text value=\"$topic10\" style='width:399px' name=topic10 size=10></td></tr>
<tr><td class=row1 align=right>Иконка: <b>img/11.png</b> &nbsp; <img src='img/11.png'></td><td class=row2><input type=text value=\"$topic11\" style='width:399px' name=topic11 size=10></td></tr>
<tr><td class=row1 align=right>Иконка: <b>img/12.png</b> &nbsp; <img src='img/12.png'></td><td class=row2><input type=text value=\"$topic12\" style='width:399px' name=topic12 size=10></td></tr>
<tr><td class=row1 align=right>Иконка: <b>img/13.png</b> &nbsp; <img src='img/13.png'></td><td class=row2><input type=text value=\"$topic13\" style='width:399px' name=topic13 size=10></td></tr>
<tr><td class=row1 align=right>Иконка: <b>img/14.png</b> &nbsp; <img src='img/14.png'></td><td class=row2><input type=text value=\"$topic14\" style='width:399px' name=topic14 size=10></td></tr>
<tr><td class=row1 align=right>Иконка: <b>img/15.png</b> &nbsp; <img src='img/15.png'></td><td class=row2><input type=text value=\"$topic15\" style='width:399px' name=topic15 size=10></td></tr>
</table>
			</div>
		</div>
	</li>
