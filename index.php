...
<input type=button class=button value='map' title='Вставить адрес для отображения его на Google maps\n\nПример: [map]Minsk Zoo[/map]' style='width:55px' onclick=\"insbb('[map]','[/map]');\">
				...
				for ($iu=0; $iu<=$usi; $iu++)
				{
					...
					if ($udt[0]==$name)
					{
						...
						if ($knopki==1)
						{
							...
							if ($_['user'])
							{
print "<details title='Посмотреть кратко профиль' style='cursor:hand;display:inline-block;font-family:tahoma;font-size:11px;font-weight:normal;text-align:left;padding:0px 1px;margin:3 0 3;'><summary style='text-align:center'></summary><div style='width:210px'><table border=0 style='border:1px solid #669900;width:210px;'>
