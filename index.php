	...
	if ($_COOKIE['cadmin']==$adminname && $_COOKIE['cpass']==$adminpass)
	{
		...
		if (isset($_GET['event']))
		{
			if ($_GET['event']=="ban")
			{
				...
				print"</SELECT> <input type=text style='width:50%' maxlength=500 name=\"text\" placeholder='Причина'> <input type=submit value='Добавить' class='fbutton'></form><br>Всего в списке: <b>$itogoban</b><br><br>* если блокируете пользователя по нику, но не знаете его IP, то впишите, например IP: 127.0.0.3</td></tr></table><br><br><a href='index.php'>&#9668; назад</a></center></body></html>";
...
if (isset($_GET['event']))
{
	if ($_GET['event']=="who")
	{
		if (!isset($_COOKIE['cname']) and !isset($_COOKIE['cpassreg']) || !$_COOKIE['cadmin']==$adminname and !$_COOKIE['cpass']==$adminpass)
			...
			exit("<br><br><br><br><br><table align=center style='border: #333 1px solid;' width=380><tr><th style='height:25px'><p style='color:red'>Доступ ограничен!</p></th></tr><tr><td><center><br><B>Для просмотра пользователей вам необходимо<br><br>::: <a href=\"index.php?mode=reg\">зарегистрироваться</a> :::</B><br><br><br>[<a href=\"javascript:history.back(1)\">вернуться назад</a>]<br><br></center></td></table>");
				...
				for ($iu=0; $iu<=$usi; $iu++)
				{
					...
					if ($udt[0]==$name)
					{
						...
						if ($knopki==1)
						{
							...
							if ($_['user'])
							{
print "<details title='Посмотреть кратко профиль' style='cursor:hand;display:inline-block;font-family:tahoma;font-size:12px;font-weight:normal;text-align:left;padding:0px 1px;margin:3 0 3;'><summary style='text-align:center;'></summary><div style='width:210px'><table border=0 style='border:1px solid #669900;width:210px'>
...
<b>Сайт:</b> <i><a href=\"$you_site\" target=_new>$you_site</a></i></small></div></details>";
...
<br><p align=center><a href=\"index.php?id=forum\">&#9668; назад</a></p>");
				...
				<tr><td><p align=center><br><b>Для создания тем на форуме необходимо<br><br>[ <a href='index.php?mode=reg'>зарегистрироваться</a> ]</b></p><br></tr></td></table>
				<br><p align=center>[<a href='javascript:history.back(1)'>вернуться назад</a>]</p>");
			}
		...
		for($a=0; $a<count($lines); $a++)
		{
			...
			if (isset($dn[2]))
			{
				...
				if ($dn[11]=="vip")
				{
					...
					if ($dn[12]>0)
					{
						print "<a href='index.php?forumid=$dn[2]' class='topic'>".trim($dn[4])."</a>&nbsp; <span style='background:red;color:#000;border-radius:4px;font-weight:bold;cursor:help;' title='Тема для пользователей имеющих $dn[12] звезд и больше (выдаёт админ)'>&nbsp;<svg aria-hidden='true' height='15' viewBox='0 0 15 15' version='1.1' width='15' data-view-component='true' style='margin:-3px 0;'><path d='M8 .25a.75.75 0 0 1 .673.418l1.882 3.815 4.21.612a.75.75 0 0 1 .416 1.279l-3.046 2.97.719 4.192a.751.751 0 0 1-1.088.791L8 12.347l-3.766 1.98a.75.75 0 0 1-1.088-.79l.72-4.194L.818 6.374a.75.75 0 0 1 .416-1.28l4.21-.611L7.327.668A.75.75 0 0 1 8 .25Zm0 2.445L6.615 5.5a.75.75 0 0 1-.564.41l-3.097.45 2.24 2.184a.75.75 0 0 1 .216.664l-.528 3.084 2.769-1.456a.75.75 0 0 1 .698 0l2.77 1.456-.53-3.084a.75.75 0 0 1 .216-.664l2.24-2.183-3.096-.45a.75.75 0 0 1-.564-.41L8 2.694Z'></path></svg> $dn[12]&nbsp;</span> $admbuttons &nbsp;";
					} else {
						if ($dn[13]>0)
						{
							print "<a href='index.php?forumid=$dn[2]' class='topic'>".trim($dn[4])."</a>&nbsp; <span style='background:red;color:#000;border-radius:4px;border:red 0px solid;font-weight:bold;cursor:help' title='Тема для пользователей с репутацией $dn[13] баллов и больше'>&nbsp;<svg aria-hidden='true' height='15' viewBox='0 0 15 15' version='1.1' width='15' data-view-component='true' style='margin:-3px 0;'><path d='M2 5.5a3.5 3.5 0 1 1 5.898 2.549 5.508 5.508 0 0 1 3.034 4.084.75.75 0 1 1-1.482.235 4 4 0 0 0-7.9 0 .75.75 0 0 1-1.482-.236A5.507 5.507 0 0 1 3.102 8.05 3.493 3.493 0 0 1 2 5.5ZM11 4a3.001 3.001 0 0 1 2.22 5.018 5.01 5.01 0 0 1 2.56 3.012.749.749 0 0 1-.885.954.752.752 0 0 1-.549-.514 3.507 3.507 0 0 0-2.522-2.372.75.75 0 0 1-.574-.73v-.352a.75.75 0 0 1 .416-.672A1.5 1.5 0 0 0 11 5.5.75.75 0 0 1 11 4Zm-5.5-.5a2 2 0 1 0-.001 3.999A2 2 0 0 0 5.5 3.5Z'></path></svg> $dn[13]&nbsp;</span> $admbuttons &nbsp;";
						} else {
