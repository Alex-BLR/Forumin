...
$knopki="0"; // Кнопки ЛС и ПП под аватаром (0- выкл, 1-вкл)
...
if (isset($_REQUEST['add'])) {
	if (strtolower($_REQUEST['secpic']) !=$_SESSION['secpic']) {
		...
		exit("<html><head><meta http-equiv='Content-Type' content='text/html; charset=windows-1251'></head><body><center><br><br><br><br><font face=tahoma size=2><b>Неверно введен защитный код!</b><br><br><a href=\"javascript:history.back()\">&#9668; назад</a></font></center>");
	}
}
...
if ($antiham == 1) {
	...
	if ($bad_ips_raw) {
		...
		if (in_array($ip, $bad_ips)) {
			die("<div style='display: flex; justify-content: center; margin-top: 100px;'><fieldset style='width: 400px; border: #333 1px solid; font-family: tahoma; text-align: center;'><legend style='color: red; font-weight: bold;'>Вы заблокированы!</legend><p style='font-size: 12px; font-weight: bold;'>Администратор запретил вам пользоваться форумом!</p></fieldset></div>");
		}
	}
}
	...
	if (isset($_POST['name']) && isset($_POST['mail']) && isset($_POST['passreg']))
	{
		...
		if (preg_match("/[^(\\w)|(\\x7F-\\xFF)|(\\-)]/", $name))
			exit("
				...
				<br><center><font size=2 face=tahoma><b>Разрешены русские и англ. буквы, цифры, подч. и тире</b></font></center>
		...
		if ($name=="" or strlen($name)>$maxname or strlen($name)<3)
			exit("
				<div align=center><br><br><br><br><br><fieldset style='width:400px;border:#333 1px solid;'><legend align='center'><font size=2 face=tahoma color=red><b>ОШИБКА</b></font></legend>
				<br><center><font size=2 face=tahoma><b>Имя пользователя должно быть от 3 до $maxname симв.</b></font></center>
				<br></fieldset></div><br><p align=center><a href='index.php?mode=reg' style='text-decoration:none;'>&#9668; назад</a></p>");

		if ($passreg=="" or strlen($passreg)<3 or strlen($passreg)>10) 
			exit("
				<div align=center><br><br><br><br><br><fieldset style='width:400px; border: #333 1px solid;'><legend align='center'><font size=2 face=tahoma color=red><b>ОШИБКА</b></font></legend>
				<br><center><font size=2 face=tahoma><b>Пароль должен быть от 3 до 10 символов!</b></font></center>
				<br></fieldset></div><br><p align=center><a href='index.php?mode=reg' style='text-decoration:none;'>&#9668; назад</a></p>");

		//В PHP 5.2+ есть встроенная функция проверки Email
		...
		if (!preg_match("/^[a-z0-9\.\-_]+@[a-z0-9\-_]+\.([a-z0-9\-_]+\.)*?[a-z]+$/is", $mail) or $mail=="" or strlen($mail)>$maxmail)
			exit("
				<div align=center><br><br><br><br><br><fieldset style='width:400px; border: #333 1px solid;'><legend align='center'><font size=2 face=tahoma color=red><b>ОШИБКА</b></font></legend>
				<br><center><font size=2 face=tahoma><b>Ваш Email некорректный либо больше $maxmail символов!</b></font></center>
				<br></fieldset></div><br><p align=center><a href='index.php?mode=reg' style='text-decoration:none;'>&#9668; назад</a></p>");
...
{
	if (empty($_POST['name']) || empty($_POST['passreg'])) exit("<br><br><br><center><font size=2 face=tahoma><b>Введите имя и пароль!</b><br><p align=center>[<a href=\"index.php?event=login\">вернуться назад</a>]</p>");
	...
	if (!$regenter) exit("<br><br><br><br><center><font size=2 face=tahoma><B>Ваши данные не верны!</B><br><br><br><p align=center>[<a href=\"index.php?event=login\">вернуться назад</a>]</p>");
	header("Location: index.php");
	exit;
}
	...
	if ($_GET['event']=="reregist")
	{
		if (!isset($_POST['name']))
			exit("
				...
				<br><center><font size=2 face=tahoma><b>Вы не ввели своё имя!</b></font></center>
		...
		if ($name=="" or strlen($name)>$maxname or strlen($name)<3)
			exit("
				<div align=center><br><br><br><br><br><fieldset style='width:400px; border: #333 1px solid;'><legend align='center'><font size=2 face=tahoma color=red><b>ОШИБКА</b></font></legend>
				<br><center><font size=2 face=tahoma><b>Имя должно быть от 3 до $maxname символов!</b></font></center>
				<br></fieldset></div><br><br><p align=center><a href='javascript:history.back(1)' style='text-decoration:none;'>&#9668; назад</a></p>");

		if (preg_match("/[^(\\w)|(\\x7F-\\xFF)|(\\-)]/", $name))
			exit("
				<div align=center><br><br><br><br><br><fieldset style='width:400px; border: #333 1px solid;'><legend align='center'><font size=2 face=tahoma color=red><b>ОШИБКА</b></font></legend>
				<br><center><font size=2 face=tahoma><b>Разрешены русские и англ. буквы, цифры, подчерк, тире</b></font></center>
				<br></fieldset></div><br><br><p align=center><a href='javascript:history.back(1)' style='text-decoration:none;'>&#9668; назад</a></p>");

		if (!isset($_POST['pass']))
			exit("
				<div align=center><br><br><br><br><br><fieldset style='width:400px; border: #333 1px solid;'><legend align='center'><font size=2 face=tahoma color=red><b>ОШИБКА</b></font></legend>
				<br><center><font size=2 face=tahoma><b>Допускается длина пароля от 3 до 10 симв.</b></font></center>
				<br></fieldset></div><br><br><p align=center><a href='javascript:history.back(1)' style='text-decoration:none;'>&#9668; назад</a></p>");
		...
		if (!preg_match("/^[a-z0-9\.\-_]+@[a-z0-9\-_]+\.([a-z0-9\-_]+\.)*?[a-z]+$/is", $email) or $email=="" or strlen($email)>$maxmail)
			exit("
				<div align=center><br><br><br><br><br><fieldset style='width:400px; border: #333 1px solid;'><legend align='center'><font size=2 face=tahoma color=red><b>ОШИБКА</b></font></legend>
				<br><center><font size=2 face=tahoma><b>Введенный Email некорректный, либо превышает $maxmail симв.</b></font></center>
				<br></fieldset></div><br><br><p align=center><a href='javascript:history.back(1)' style='text-decoration:none;'>&#9668; назад</a></p>");
		...
		$notgood="<br><br><a href='javascript:history.back(1)' style='text-decoration:none;'>&#9668; назад</a></b></font></p>";

		if (strlen($dayx)>10) exit("<br><br><br><p align=center><font size=2 face=tahoma><b>Введено много данных ДЕНЬ РОЖДЕНИЯ (макс 10 симв) $notgood");
		if (strlen($icq)>12) exit("<br><br><br><p align=center><font size=2 face=tahoma><b>Введено много данных KICQ (макс 12 симв) $notgood");
		if (strlen($telegram)>40) exit("<br><br><br><p align=center><font size=2 face=tahoma><b>Введено много данных Telegram (макс 40 симв) $notgood");
		if (strlen($www)>40) exit("<br><br><br><p align=center><font size=2 face=tahoma><b>Введено много данных САЙТ (макс 40 симв) $notgood");
		if (strlen($about)>50) exit("<br><br><br><p align=center><font size=2 face=tahoma><b>Введено много данных ОТКУДА (макс 50 симв) $notgood");
		if (strlen($work)>100) exit("<br><br><br><p align=center><font size=2 face=tahoma><b>Введено много данных ИНТЕРЕСЫ (макс 100 симв) $notgood");
		if (strlen($write)>150) exit("<br><br><br><p align=center><font size=2 face=tahoma><b>Введено много данных ПОДПИСЬ (макс 150 симв) $notgood");
		...
		do {
			...
			if (strtolower($name) === strtolower($rdt[0]) & $oldpass === $rdt[1]) $ok="$i"; // Ищем юзера
		...
		if ($_FILES['file']['name']!="")
		{
			...
			if (preg_match("/\.php|\.htm|\.html|\.mht|\.mhtml|\.hta|\.vb|\.vbs|\.vbe|\b\.js\b|\b\.jse\b|\b\.jar\b/i",$fotoname))
				exit("<br><br><br><p align=center><font size=2 face=tahoma><b>Ваш файл имеет запрещённое расширение!</b><br><br><a href='javascript:history.back(1)'>&#9668; назад</a></p>");
...
if (is_file("data/".$forumid.".user"))
{
	...
	{
		if (preg_match("/\b".$user."\b/i", $tub[0])) exit("<div align=center><br><br><br><br><br><fieldset style='width:400px;border: #333 1px solid;'><legend align=center><font size=2 face=tahoma color=red><b>Внимание!</b></font></legend><br><font size=2 face=tahoma>Автор темы установил запрет на чтение!</font><br></fieldset><br><br><font size=2 face=tahoma><a href=\"index.php\" style='text-decoration:none;'>[вернуться на форум]</a></font></div>");
	}
	if (!empty($tub[1]) & $tub[3]=="1")
	{
		if (!preg_match("/\b".$user."\b/i", $tub[1])) exit("<div align=center><br><br><br><br><br><fieldset style='width:400px;border: #333 1px solid;'><legend align=center><font size=2 face=tahoma color=red><b>Внимание!</b></font></legend><font size=2 face=tahoma>Читать тему могут только пользователи:<br><b>$tub[1]</b></font><br></fieldset><br><br><font size=2 face=tahoma><a href=\"index.php\" style='text-decoration:none;'>[вернуться на форум]</a></font></div>");
	}
}
...
if (isset($name) && isset($msg) && isset($email) && isset($_POST['forumid']) && isset($_POST['action']) && $_POST['action']=="answer")
{
	if (strlen($msg)>2 && strlen($msg)<$maxmsg)
	{
		...
		exit("
			<div align=center><br><br><br><br><br><fieldset style='width:420px; border: #333 1px solid;'><legend align='center'><font size=2 face=tahoma color=red><b>ОШИБКА</b></font></legend>
			<br><center><font size=2 face=tahoma><b>Сообщение не должно быть пустым или менее 2-х символов, а также не должно превышать $maxmsg символов!</b></font></center>
			<br></fieldset></div><br><br><p align=center><a href='javascript:history.back(1)' style='text-decoration:none;'>&#9668; назад</a></p>");
	}
}
...
if (isset($_COOKIE['cadmin']) && isset($_COOKIE['cpass']))
{
	if ($_COOKIE['cadmin'] === $adminname && $_COOKIE['cpass'] === $adminpass)
	{
		...
		if (isset($_GET['badip']))
		{
			...
			if (strlen($ip)<7) exit("<br><br><br><center><b>Вы неправильно ввели IP-адрес!</b><br><br><a href='javascript:history.back(1)'>&#9668; назад</a>");
...
<div class=rgb><mark><input type=button class=button value='R' title='Красный цвет текста' style='color:red;' onclick=\"insbb('[red]','[/red]')\"></mark>
...
<input type=button class=button value='Y' title='Желтый цвет текста' style='font-weight:bold;color:yellow' onclick=\"insbb('[yellow]','[/yellow]')\"></div>
...
<div class=align><mark><input type=button class=button value='=--' title='Выровнять текс влево' onclick=\"insbb('[left]','[/left]')\"></mark>
<input type=button class=button value='-=-' title='Центрировать текст' onclick=\"insbb('[center]','[/center]')\">
<input type=button class=button value='--=' title='Выровнять текст вправо' onclick=\"insbb('[right]','[/right]')\"></div>
...
<br><p align=center><a href=\"javascript:history.back(1)\">&#9668; назад</a></p></body></html>";
	...
	} else echo "<div align=center><br><br><br><br><br><fieldset style='border: #555 1px solid; width:400px'><legend align='center'><font size=2 face=tahoma color=red><b>Внимание!</b></font></legend>
			<br><center><font size=2 face=tahoma><b>Вы не можете редактировать это сообщение, так как установленное для этого время истекло!</b></font></center>
...
if (isset($_GET['event']))
{
	if ($_GET['event']=="who")
	{
		if (!isset($_COOKIE['cname']) and !isset($_COOKIE['cpassreg']) || !$_COOKIE['cadmin']==$adminname and !$_COOKIE['cpass']==$adminpass)
			...
			exit("<br><br><br><br><br><table align=center style='border: #333 1px solid;' width=380><tr><th style='height:25px'><p style='color:red'>Доступ ограничен!</p></th></tr><tr><td><center><br><br><B>Для просмотра пользователей вам необходимо<br><br>[<a href=\"index.php?mode=reg\">зарегистрироваться</a>]</B><br><br><br></center></td></table><br><p align=center><a href='javascript:history.back(1)'>&#9668; назад</a></p>");
		...
		if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['msg']) && isset($_POST['forumid']) && isset($_POST['action']) && $_POST['action']=="answer" && $readonly==0)
		{
			...
			if (isset($_FILES['file']['name'])) // ЕСЛИ ДОБАВЛЯЕМ ФАЙЛ
			{
				...
				if (strlen($fotoname)>1)
				{
					...
					if (!in_array($ext, $valid_types_load)) exit("<div align=center><br><br><br><br><br><fieldset style='width:350px'><legend align='center'><font size=2 face=tahoma color=red><b>Файл не загружен.  Причины:</b></font></legend><br><center><font size=2 face=tahoma>1) недопустимое расширение файла<br>2) файл с двойным расширением<br>3) испорченный файл картинки</font></center><br></fieldset></div><br><br><p align=center><a href='javascript:history.back(1)'>назад</a></p>");

					// Считаем КОЛ-ВО ТОЧЕК
					$findtchka=substr_count($fotoname, ".");

					if ($findtchka>1) exit("<br><br><br><center><font size=3 face=arial>В имени загружаемого файла точек больше одной!<br><p align=center><a href='javascript:history.back(1)'>&#9668; назад</a></p></font></center>");

					// Если в имени есть .php и т.д.
					if (preg_match("/\.php|\.htm|\.html|\.mht|\.mhtml|\.hta|\.vb|\.vbs|\.vbe|\b\.js\b|\b\.jse\b|\b\.jar\b/i", $fotoname)) exit("<br><br><br><center><font size=3 face=arial>У вашего файла недопустимое расширение!<br><p align=center><a href='javascript:history.back(1)'>назад</a></p></font></center>");
					...
					if (!preg_match("/^[a-z0-9\.\-_]+\.(".$patern.")+$/is",$fotoname)) exit("<br><br><br><center><font size=3 face=arial>Запрещены русские буквы и пробелы в имени файла!<br><p align=center><a href='javascript:history.back(1)'>назад</a></p></font></center>");

					// Проверяем, может быть файл с таким именем уже есть на сервере
					if (file_exists("$filedir/$fotoname")) exit("<br><br><br><center><font size=3 face=arial>Файл с таким именем уже существует. Измените имя на другое!<br><p align=center><a href='javascript:history.back(1)'>назад</a></p></font></center>");
					...
					if ($fotoksize>$fotomax) exit("<br><br><br><center><font size=3 face=arial>Вы превысили допустимый размер файла <b>$fotomax</b>Кб<br><br>Вы загружаете файл размером <b>$fotoksize</b>Кб<br><p align=center><a href='javascript:history.back(1)'>назад</a></p></font></center>");
		...
		if (file_exists("data/".$forumid))
		{
			...
			for ($i=$p; $i<min($mpp+$p, $cnt); $i++)
			{
				...
				for($a=0; $a<count($lines); $a++)
				{
					...
					if ($forumid==$dttt[2])
					{
						if (empty($_['user']) & $dttt[12]>0 || empty($_['user']) & $dttt[13]>0) exit("<script>setTimeout(function(){window.location.href='index.php';},10000);</script><br><br><br><br><center><fieldset style='width:500px;border:solid 1px #777;'><legend align=center><font color=red>Доступ ограничен!</font></legend>Для просмотра этой темы вы должны быть зарегистрированы!<br><br>[<a href=\"index.php\">вернуться назад</a>]</fieldset></center>");

						if (isset($_COOKIE['cadmin']) && isset($_COOKIE['cpass']) && $_COOKIE['cadmin']==$adminname && $_COOKIE['cpass']==$adminpass)
						{
							continue;
						} else {
							if ($_['user'] && $you_zvezd<$dttt[12]) exit("<script>setTimeout(function(){window.location.href='index.php';},10000);</script><br><br><br><br><center><fieldset style='width:500px;border:solid 1px #777;'><legend align=center><font color=red>Доступ ограничен!</font></legend>Для просмотра вы должны иметь минимум <b>$dttt[12]</b> звёзд. У вас <b>$you_zvezd</b> звёзд.<br><br>[<a href=\"index.php\">вернуться назад</a>]</fieldset></center>");

							if ($_['user'] && $you_repa<$dttt[13]) exit("<script>setTimeout(function(){window.location.href='index.php';},10000);</script><br><br><br><br><center><fieldset style='width:500px;border:solid 1px #777;'><legend align=center><font color=red><b>Доступ ограничен!</b></font></legend>Для просмотра вы должны иметь минимум <b>$dttt[13]</b> баллов репутации. У вас <b>$you_repa</b><br><br>[<a href=\"index.php\">вернуться назад</a>]</fieldset></center>");
						}
					}
				}
...
<tr><td width='35px'><b style='font-family:tahoma;font-size:11px'>Who:</b></td><td><i style='font-family:tahoma;font-size:11px'>$newstatus[0]</i></td></tr>
...
<tr><td><b style='font-family:tahoma;font-size:11px'>Tgm:</b></td><td><i style='font-family:tahoma;font-size:11px'><a href=\"$you_telegram\" target=_new>$you_telegram</a></i></td></tr>
...
<b>Who:</b> <i>$newstatus[0]</i><br>
<b>Reg:</b> <i>$you_datareg [#$userpn]</i><br>
<b>Frm:</b> <img src=\"flags/$flagpr\"/> <i>$you_flag_name $you_from</i><br>
<b>Kicq:</b> <i>$you_icq</i><br>
<b>Tgm:</b> <i>$you_telegram</i><br>
<b>Web:</b> <i><a href=\"$you_site\" target=_new>$you_site</a></i></small></div></details>";
			...
			if (is_file("data/".$forumid.".user"))
			{
				...
				if (!empty($tu[0]))
				{
					if ((preg_match("/\b".$name."\b/i", $tu[0])) && !strstr($you_status,"администратор")) exit("<div align=center><br><br><br><br><br><fieldset style='width:400px;border: #333 1px solid;'><legend align='center'><font size=2 face=tahoma color=red><b>Внимание!</b></font></legend><br><center><font size=2 face=tahoma><b>Автор темы запретил вам участвовать в обсуждении!</b></font></center><br></fieldset><br><br><font size=2 face=tahoma><a href=\"index.php\" style='text-decoration:none;'>[вернуться назад]</a></font></div>");
				}
				if (!empty($tu[1]))
				{
					if ((!preg_match("/\b".$name."\b/i", $tu[1])) && !strstr($you_status,"администратор")) exit("<div align=center><br><br><br><br><br><fieldset style='width:400px;border: #333 1px solid;'><legend align='center'><font size=2 face=tahoma color=red><b>Внимание!</b></font></legend><br><center><font size=2 face=tahoma><b>Участвовать в теме может админ и пользователи:<br>$tu[1]</b></font></center><br></fieldset><br><br><font size=2 face=tahoma><a href=\"index.php\" style='text-decoration:none;'>[вернуться назад]</a></font></div>");
				}
			}
...
<input type=button class=button value='ok.ru' title='Вставить видео с Одноклассников\nПример:\n[ok]https://ok.ru/video/7364277307929[/ok]' style='width:50px' onclick=\"insbb('[ok]','[/ok]')\"></div>
<input type=button class=button value='telegram' title='Вставить сообщение из Телеграм.\nСкопируйте в Телеграме ссылку на сообщение и вставьте в тег\n\nПример: [telegram]https://t.me/youtubequest/3[/telegram]' style='width:55px' onclick=\"insbb('[telegram]','[/telegram]');\">
<input type=button class=button value='map' title='Показать адрес на карте Google maps\n\nПример: [map]Minsk Zoo[/map]' style='width:55px' onclick=\"insbb('[map]','[/map]');\">
[<a href='#' onclick='toggleStats(); return false;' style='cursor:pointer;'>FAQ</a>] [<a href='#' onclick=\"window.open('uploader.php', 'upload', 'width=640,height=420,left=100,top=100,toolbar=0,status=0,border=0,scrollbars=1');return false;\" style='text-decoration:none' title='Закачка картинок на сайт'>UPL</a>]
...
<br><p align=center><a href=\"index.php?id=forum\">&#9668; назад</a></p>");
				...
				exit("<br><br><br><br><br><table align=center style='border:#333 1px solid' width='380px'><tr><th style='height:25px'><font color=red>Доступ ограничен!</font></th></tr>
				<tr><td><center><br><br><b>Для создания тем на форуме необходимо<br><br>[<a href='index.php?mode=reg'>зарегистрироваться</a>]</b><br><br><br></tr></td></table>
				<br><p align=center><a href='javascript:history.back(1)'>&#9668; назад</a></p>");
			}
